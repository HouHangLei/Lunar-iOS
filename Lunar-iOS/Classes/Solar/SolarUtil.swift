...
public class SolarUtil: NSObject {
    ...
    class func convertTime(year: Int) -> Bool {
    ...
    class func getDaysOfYear(year: Int) -> Int32 {
    ...
    ///   - month: 月份
    /// - Returns: 这个月的天数
    class func getDaysOfMonth(year: Int, month: Int) -> Int32 {
    ...
    /// - Returns: 某月周数
    class func getWeeksOfMonth(year: Int, month: Int, start: Int) -> Int32 {
    ...
    ///   - day: 阳历日(数字)。
    /// - Returns: 某天位于当年第几天
    class func getDaysInYear(year: Int, month: Int, day: Int) -> Int32 {
